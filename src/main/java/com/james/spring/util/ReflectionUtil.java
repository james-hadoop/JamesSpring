...
public class ReflectionUtil extends ReflectionUtils {
    ...
    public static boolean setValueByFieldName(Object obj, String fieldName, Object value) {
        try {
            ...
            /**
             * public void setAccessible(boolean flag) throws SecurityException将此对象的
             ...
             * true，并且不能更改此对象的可访问性（例如，如果此元素对象是 Class 类的 Constructor 对象），则会引发
             * SecurityException。 如果此对象是 java.lang.Class 类的 Constructor 对象，并且 flag 为
             * true，则会引发 SecurityException。 参数： flag - accessible 标志的新值 抛出：
