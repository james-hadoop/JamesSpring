...
public class LeyaoWebSqlProvider {

    public String insertSelective(LeyaoWeb record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("leyao_web");
    ...
    public String updateByPrimaryKeySelective(LeyaoWeb record) {
        SQL sql = new SQL();
        sql.UPDATE("leyao_web");
